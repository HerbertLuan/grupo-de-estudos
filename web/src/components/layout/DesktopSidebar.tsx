...
export function DesktopSidebar() {
  ...
  return (
    <div className="hidden lg:flex flex-col w-[240px] bg-bg-secondary border-r border-border h-screen sticky top-0">
      <div className="p-6">
        <h1 className="text-xl font-bold text-text-primary tracking-tight">Grupo de<br/><span className="text-accent-primary">Estudos</span></h1>
      </div>
      ...
      <div className="p-4 border-t border-border mt-auto">
        <button 
          ...
          className="flex items-center gap-3 w-full p-2 rounded-xl hover:bg-bg-tertiary transition-colors text-left"
        >
          <Avatar name={displayName} size="md" />
          <div className="overflow-hidden">
            <p className="text-sm font-medium text-text-primary truncate">{displayName}</p>
            <p className="text-xs text-text-muted truncate">Meu Perfil</p>
          </div>
        </button>
      </div>
    </div>
